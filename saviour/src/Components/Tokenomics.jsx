      ...
      >
        ...
        <div className="flex  flex-col md:flex-row justify-around items-center mt-10 ">
            ...
            <table className="  text-white font-ZCOOLKuaiLe  text-center  p-3 w-full">
              <tbody>
                <tr>
                  <td>Name</td>
                  <td>
                    <span className="text-red-600 ">Saviour</span>
                  </td>
                </tr>{" "}
                <br />
                <tr>
                  <td>Symbol</td>
                  <td>
                    <span className="text-red-600">SVR</span>
                  </td>
                </tr>
                <br />
                <tr>
                  <td>Total Supply</td>
                  <td>
                    <span className="text-red-600">100 Trillion</span>
                  </td>
                </tr>
                <br />
                <tr>
          ...
          <div className=" relative w-full md:w-1/2 mt-[50px]">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/3 w-1/3">
